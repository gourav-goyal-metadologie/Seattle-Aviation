...
import customerQuoteReportByPartNameCtrl from '@salesforce/apex/customerQuoteReportByPartNameCtrl.getOrderReportResults';

const columns = [
    { label: 'Part Numbers', fieldName: 'partNumber' },
    { label: 'PN Keyword', fieldName: 'pnKeyword', type: 'string' },
    { label: 'Total Orders', fieldName: 'totalQuotes' },
