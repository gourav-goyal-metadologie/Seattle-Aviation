...
export function transformData(data, cardContentMapping, pagevalue) {

    const DEFAULT_PAGE_SIZE = 40; // data for fixed page size
    //var DEFAULT_PAGE_SIZE = 40;
    var { productsPage = {}, categories = {}, facets = [], locale = '' } =
        data || {};
    var {
        currencyIsoCode = '',
        total = 0,
