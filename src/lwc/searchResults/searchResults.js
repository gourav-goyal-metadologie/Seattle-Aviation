...
export default class SearchResults extends NavigationMixin(LightningElement) {
    ...
    // change the default page size using onchange 
    @track pagevalue='20';
    get options() {
        return [
            { label: '20', value: '20' },
    ...
    triggerProductSearch() {
        ...
        // this.resolvedEffectiveAccountId='0016s00000Dn3DtAAJ';
        productSearch({
            communityId: communityId,
            searchQuery: searchQuery,
            effectiveAccountId: this.resolvedEffectiveAccountId
    ...
    set displayData(data) {
        this._displayData = transformData(data, this._cardContentMapping, this.pagevalue);
    }
    ...
    get hasMorePages() {
        ...
        // return this.displayData.total > pagevalue;
    ...
    get headerText() {
        let text = '';
        var totalItemCount = this.displayData.total;
        var pageSize = this.displayData.pageSize;

        if (totalItemCount > 1) {
            var startIndex = (this._pageNumber - 1) * pageSize + 1;
            ...
            text = `${startIndex} - ${endIndex} of ${totalItemCount} Products`;
    ...
    get resolvedEffectiveAccountId() {
        ...
        var effectiveAcocuntId = this.effectiveAccountId || '';
        let resolved = null;
     ...
     */
    get isCartLocked() {
        var cartStatus = (this._cartSummary || {}).status;
    ...
    updateSearchResultLayout(e){
        this.resultsLayout = '';
        this.resultsLayout = e.target.value;
        console.log('updateSearchResultLayout: ',this.resultsLayout);
    }

    get resultsLayoutOptions(){
        return [
